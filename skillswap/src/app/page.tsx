...
export default function Homepage() {
  return (
    <>
      ...
      <div className="fixed top-0 left-0 w-full bg-transparent shadow-md flex items-center px-8 py-4">
        <img src="/images/homepage/favicon.png" alt="Skill Swap Logo" className="w-[80px] h-auto"/>
      </div>
